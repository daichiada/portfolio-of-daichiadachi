...
──────────────────────
足立大地
E-mail:mojiblogchan@gmail.com
URL: https://portfolio-daichi-adachi.com/
──────────────────────
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://portfolio-daichi-adachi.com/" target="_blank">- アダチダイチのポートフォリオに戻る -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
